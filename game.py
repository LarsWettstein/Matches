...
def registerPlayers(players):
    numberOfPlayers = input("With how many  you want to play? ")    
...
while winner == False:
    ...
    temp = input("{}: how many matcher do you want to take? (pick between 1 and 3) ".format(getActivePlayer(roundCount, players)))
    ...
    if matchesCount == 0:    
       print("{} is the WINNER!!!".format(getActivePlayer(roundCount, players)))
       winner = True
